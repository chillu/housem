...
CREATE TABLE public.my_activities (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
ALTER TABLE ONLY public.my_activities
...
ALTER TABLE ONLY public.my_activities
    ADD CONSTRAINT my_activities_activity_id_fkey FOREIGN KEY (activity_id) REFERENCES public.activities(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.my_activities
